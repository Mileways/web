<template>
  ...
  >
    <div class="container mx-auto">
      ...
      <h1 class="text-5xl sm:text-6xl mt-3 font-black text-white">Flying August 25th. You may stay excited!</h1>
...
export default {
  layout: 'empty',
  components: { MailChimpSignUpForm, TwitterFollowButton }
}
</script>
...
.action-item {
  @apply inline-flex items-center bg-white text-black border-white border-2 overflow-hidden rounded-lg;
  width: 256px;
}
@screen sm {
  .action-item-wrapper {
